...
import { canReviewOperationalAttendance } from "./InventoryOperationalSection";

function buildRow(
  id: string,
  confirmationStatus: InventoryAttendanceSummaryEmployee["confirmationStatus"],
  operationalStatus: InventoryAttendanceSummaryEmployee["operationalStatus"],
  attendanceId: string | null,
): InventoryAttendanceSummaryEmployee {
  return {
    employee: {
      id,
      name: `Employee ${id}`,
...
function renderTable(rows: InventoryAttendanceSummaryEmployee[], onReviewApprove = () => {}) {
  return render(
...
describe("InventoryOperationalEmployeeTable", () => {
