...
export interface InventoryOperationalEmployeeTableProps {
  inventoryId: string;
  rows: InventoryAttendanceSummaryEmployee[];
  scheduledStart: string;
  loading?: boolean;
  error?: string;
  canAssign: boolean;
  canReviewAttendance: (row: InventoryAttendanceSummaryEmployee) => boolean;
...
export function InventoryOperationalEmployeeTable({
  inventoryId,
  rows,
  scheduledStart,
  loading = false,
  ...
  emptyTitle,
  emptyDescription,
}: InventoryOperationalEmployeeTableProps) {
