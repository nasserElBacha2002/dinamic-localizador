import type { GoogleAddressComponent } from "../../../utils/service-location";
...
export const resolveManualState = (
  current: import("../../../utils/service-location").LocationPickerState,
): import("../../../utils/service-location").LocationPickerState => {
