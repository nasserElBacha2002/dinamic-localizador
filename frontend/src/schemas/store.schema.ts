...
export const storeFormSchema = z.object({
  ...
  localidad: z.string().trim().optional().or(z.literal("")),
  formato: z.union([storeFormatSchema, z.literal("")]).optional(),
...
export function toNullableStoreFormat(value: StoreFormValues["formato"]): StoreFormat | null {
  if (!value) {
    return null;
  }
