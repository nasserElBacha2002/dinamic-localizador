...
export type CreateServiceInput = z.infer<typeof createStoreSchema>;
export type UpdateServiceInput = z.infer<typeof updateStoreSchema>;
export type ListServicesQuery = z.infer<typeof listStoresQuerySchema>;
